...
<h2 style="color: #2c3e50;">Мои обучающие карточки</h2>
  <p style="font-size: 1.1rem; color: #F2F2F2;">
    Нажимайте на карточку, чтобы увидеть ответ. </b> Если вопрос вызвал затруднение, нажмите на кнопку "для повторения" под карточкой. </b>
